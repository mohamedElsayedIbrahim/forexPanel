        ...
        <div class="container">
            ...
            <div class="bady">
              @include('layouts.includes.errors')
                <form enctype="multipart/form-data" class="row g-3 needs-validation" novalidate method="POST" action="{{route('sliders.update',$slider->id)}}">
                  
                  @csrf

                  <div class="col-md-12">
                    <label for="validationCustomUsername" class="form-label">slider image</label>
                      <input type="file" name="logo" accept=".jpg,.png,.webp" class="form-control" value="{{old('poster')}}" id="validationCustomUsername" aria-label="file example" aria-describedby="inputGroupPrepend">
                  ...
                  <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" maxlength="200" rows="5" name="content" required>{{$slider->content ?? old('content')}}</textarea>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-12">
                    <label for="validationCustomUsername" class="form-label">slider button text</label>
                      <input type="text" name="btn" maxlength="50" class="form-control" value="{{$slider->btn_value ?? old('btn')}}" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
                  ...
                  <div class="col-md-12">
                    <label for="validationCustomUsername" class="form-label">slider button Url</label>
                      <input type="url" name="url" maxlength="250" class="form-control" value="{{$slider->link ??old('url')}}" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
