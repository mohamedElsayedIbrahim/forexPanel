    ...
    <section class="content p-5">
      ...
      @foreach ($userPermission as $item)
          ...
          <div class="col-md-3 my-2">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><a href="{{route('adverticers.index')}}" class="card-link">Site Adverticers</a></h5>
                  <h6 class="card-subtitle mb-2 text-muted">Site Adverticers</h6>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="{{route('adverticers.index')}}" class="card-link">use service</a>
                </div>
            </div>
          </div>
          @endif
