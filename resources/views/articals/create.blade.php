        ...
        <div class="container">
            ...
            <div class="bady">
              @include('layouts.includes.errors')
                <form enctype="multipart/form-data" class="row g-3 needs-validation" novalidate method="POST" action="{{route('articals.store')}}">
                  ...
                  <div class="col-md-12">
                    <label for="content" class="form-label fw-bold">Artical Page Contnet</label>
                    <textarea class="form-control" id="content" rows="5" name="content" required>{{old('content')}}</textarea>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-12">
                    <label for="validationCustomUsername" class="form-label">Meta keywords</label>
                      <input type="text" name="keywords" maxlength="200" class="form-control" value="{{old('keywords')}}" id="validationCustomUsername" aria-describedby="inputGroupPrepend" >
                      <div class="invalid-feedback">
                        Please choose a artical title.
                      </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <label for="validationCustomUsername" class="form-label">Meta description</label>
                      <input type="text" name="desc" maxlength="150" class="form-control" value="{{old('desc')}}" id="validationCustomUsername" aria-describedby="inputGroupPrepend">
                      <div class="invalid-feedback">
                        Please choose a artical title.
                      </div>
                  </div>
